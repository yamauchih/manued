...
\begin{abstract}
 Manued is a document proofreading method, stands for MANUscript EDiting
 language. This proofreading is simple and systematic. We present
 \texttt{manued.el}, which is an emacs lisp implementation to support
 this method. Manued method itself doesn't depend on a media (paper,
 digital document, and so on), though it is especially effective for
 exchanging digital texts via email.
\end{abstract}
\tableofcontents
\newpage
\begin{rawhtml}
...
\subsection{What is Manued?}

Manued is a document proofreading method. This method makes proofreading
more systematic and simpler. \texttt{manued.el} is an emacs program to
support this proofreading method.
